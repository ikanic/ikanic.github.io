...
```mermaidc
flowchart TD
    _start[ ] --특정 화면 진입--> st1[loadView]
    st1 --> st2[viewDidLoad]
    st2 --> st3[viewWillAppear]
    st3 --> st4[viewDidAppear]
    st4 --> st5[viewWillDisappear]
    st5 --> st6[viewDidDisappear]
    st6 --> st3

    style _start opacity: 0
    style st1 fill: #fdfdfd, stroke: #ccc, color: #999
```
