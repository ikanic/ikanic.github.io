...
7기를 시작하던 당시는 `Apple Developer Academy @ POSTECH` 1기 활동을 시작한 지 한 달이 조금 지난 시점이었는데, 초반 2~3달 정도는 아카데미 일정이 그렇게 빡빡하지도 않았고, 빡빡하더라도 프로젝트에서 사용한 기술 하나하나를 정리하니 생각보다 글 쓰는 게 어렵지 않았습니다.
